...
The $\mu$, n, and $\gamma$ fluence (differential in angle and energy) per electrons-on-target (EOT) were  calculated   at XXX cm  downstream of the beam-dump exit, through a circular area of 105 cm$^2$. Figure~\ref{fig:fluka-bd} shows the FLUKA graphic representation of the beam-dump and the location of the flux detector.
